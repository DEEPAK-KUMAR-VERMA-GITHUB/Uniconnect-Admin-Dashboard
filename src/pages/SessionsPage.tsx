...
const SessionsPage = () => {
  ...
  useEffect(() => {
    if (selectedSession) {
      ...
      sessionForm.reset({
        ...
        startDate: formatDateForInput(selectedSession.startDate),
        endDate: formatDateForInput(selectedSession.endDate),
      });
    } else {
      sessionForm.reset({
        name: "",
  ...
  const {
    ...
    isError,
    error,
  } = useSessions(currentPage, sessionsPerPage);
  ...
  const handleDelete = useCallback(
    ...
    [deleteSessionMutation, queryClient, toast]
  );
  ...
  const handleStatusChange = useCallback(
    ...
    [updateSessionStatusMutation, queryClient, toast]
  );
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Manage academic sessions and their details
              </p>
            </div>
